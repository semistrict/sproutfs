...
and step 4's mapping budget; steps 5 to 7 are planned. Step 4 has one open
defect against it — a fan-out panics a child's guest kernel at 4 KiB — which
[open-work.md](../docs/open-work.md) carries and which must be understood before
this geometry ships.**
