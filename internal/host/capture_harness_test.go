...
var testSpecs = []volume.VolumeSpec{
	{Name: "ram", Size: 3 * checkpoint.PageSize2MiB, PageSize: checkpoint.PageSize2MiB},
	{Name: "pmem", Size: checkpoint.PageSize2MiB + 3*checkpoint.SectorSize, PageSize: checkpoint.PageSize2MiB},
}
